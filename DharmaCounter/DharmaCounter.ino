...
void initEEPROM ()
{
  ...
  {
    //Arduboy related EEPROM changes
    arduboy.writeShowBootLogoFlag(false);       //Do not show Arduboy logo
    arduboy.writeShowBootLogoLEDsFlag(false);   //Do not flash RGB LED
